class Button:
    ...
    def __init__(self,length,width,x,y,text,visibility,key,colour):
        ...
        (str), and the colour (all the colours are set as RGBs inside the
        button_draw method). """
    ...
    def button_draw(self):
        ...
        Also if the button is black the text will appear as white and vise versa. The
        last if statement will turn the button red if it's pressed  """
